...
export const DASHBOARDS: Dashboard[] = [
  {
    ...
    icon: Gauge,
    subtitle: "Trade, stock and cash position on one screen",
    description:
      "The first screen an owner opens: open shipments, letters of credit in transit and stock value, with the shipment trend behind them.",
    kpis: HERO_KPIS,
    chart: {
      kind: "area",
      caption: "Shipments handled, last 6 months",
      xKey: "month",
      data: HERO_TREND,
      series: [{ key: "shipments", label: "Shipments" }],
    },
    insights: [
      "Open shipments and LCs in transit at a glance",
      "Stock value with period-on-period movement",
      "Shipment volume trend by month",
      "Feeds the Power BI model and Grafana panels",
    ],
    tone: "bg-indigo-500/10 text-indigo-600 dark:text-indigo-400",
  },
  {
